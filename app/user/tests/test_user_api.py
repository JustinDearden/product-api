...
# constant to hold the url for reverse
CREATE_USER_URL = reverse('user:create')
TOKEN_URL = reverse('user:token')
ME_URL = reverse('user:me')


# helper function to return the create user model line
...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_success(self):
        ...
        # expect an http 201 (created user)
    ...
    def test_user_password_too_short(self):
        """Test that the passord must be more than 5 characters"""
        payload = {
            'email': 'test@gmail.com',
            'password': 'test1234',
        }
